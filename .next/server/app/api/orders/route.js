"use strict";(()=>{var e={};e.id=146,e.ids=[146],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2081:e=>{e.exports=require("child_process")},6113:e=>{e.exports=require("crypto")},9523:e=>{e.exports=require("dns")},2361:e=>{e.exports=require("events")},7147:e=>{e.exports=require("fs")},3685:e=>{e.exports=require("http")},5687:e=>{e.exports=require("https")},1808:e=>{e.exports=require("net")},2037:e=>{e.exports=require("os")},1017:e=>{e.exports=require("path")},2781:e=>{e.exports=require("stream")},4404:e=>{e.exports=require("tls")},7310:e=>{e.exports=require("url")},3837:e=>{e.exports=require("util")},9796:e=>{e.exports=require("zlib")},2758:(e,r,t)=>{t.r(r),t.d(r,{originalPathname:()=>m,patchFetch:()=>g,requestAsyncStorage:()=>c,routeModule:()=>d,serverHooks:()=>h,staticGenerationAsyncStorage:()=>u});var s={};t.r(s),t.d(s,{POST:()=>p});var o=t(9303),n=t(8716),a=t(670),i=t(7070),l=t(6119);async function p(e){try{let r=await e.json();if(!r.name||!r.address||!r.city||!r.contactValue||!r.products||0===r.products.length)return i.NextResponse.json({success:!1,error:"Vul alle verplichte velden in"},{status:400});if(!await (0,l.V)(r))return i.NextResponse.json({success:!1,error:"Er ging iets mis bij het versturen. Probeer het opnieuw."},{status:500});return i.NextResponse.json({success:!0,message:"Bestelling succesvol verzonden!"})}catch(e){return console.error("Order submission error:",e),i.NextResponse.json({success:!1,error:"Server error"},{status:500})}}let d=new o.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/orders/route",pathname:"/api/orders",filename:"route",bundlePath:"app/api/orders/route"},resolvedPagePath:"/Users/baskoerhuis/jelte3D/app/api/orders/route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:c,staticGenerationAsyncStorage:u,serverHooks:h}=d,m="/api/orders/route";function g(){return(0,a.patchFetch)({serverHooks:h,staticGenerationAsyncStorage:u})}},6119:(e,r,t)=>{t.d(r,{V:()=>n,r:()=>a});var s=t(5245);function o(){return s.createTransport({host:process.env.SMTP_HOST||"smtp.strato.com",port:parseInt(process.env.SMTP_PORT||"465"),secure:!0,auth:{user:process.env.SMTP_USER,pass:process.env.SMTP_PASS}})}async function n(e){try{let r=o(),t=process.env.ORDER_EMAIL||"jeltevveen@gmail.com",s={from:process.env.SMTP_USER,to:t,subject:`🎯 Nieuwe Bestelling van ${e.name}`,html:function(e){let{name:r,address:t,city:s,contactMethod:o,contactValue:n,products:a,dropoffLocation:i,comments:l}=e;return`
<html>
<head>
  <style>
...
<body>
  ...
  <div class="info">
    ${e.message.replace(/\n/g,"<br>")}
      ...
      `};return await r.sendMail(s),!0}catch(e){return console.error("Error sending contact email:",e),!1}}}};var r=require("../../../webpack-runtime.js");r.C(e);var t=e=>r(r.s=e),s=r.X(0,[948,972,245],()=>t(2758));module.exports=s})();